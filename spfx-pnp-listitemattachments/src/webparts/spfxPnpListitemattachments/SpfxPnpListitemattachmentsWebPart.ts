...
import { ISpfxPnpListitemattachmentsProps } from './components/ISpfxPnpListitemattachmentsProps';
...
export default class SpfxPnpListitemattachmentsWebPart extends BaseClientSideWebPart <ISpfxPnpListitemattachmentsWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ISpfxPnpListitemattachmentsProps> = React.createElement(
      SpfxPnpListitemattachments,
      {
