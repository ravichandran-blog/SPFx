...
import { ISpfxPnpTreeviewProps } from './components/ISpfxPnpTreeview';

export interface ISpfxPnpTreeviewWebPartProps {
  description: string;
}

export default class SpfxPnpTreeviewWebPart extends BaseClientSideWebPart<ISpfxPnpTreeviewWebPartProps> {
